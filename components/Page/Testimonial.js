...
const testimonials = [
    {
        name: "Aisha Bello",
        text: "Adeniran Foundation provided me with school supplies and mentorship. I now have hope for my future!",
    },
    {
        name: "Emeka Okafor",
        text: "Thanks to Adeniran Foundation, my family received food support during tough times. Forever grateful!",
    },
    {
        name: "Fatima Sule",
        text: "I got a scholarship for my studies. Adeniran Foundation changed my life!",
    },
    {
        name: "John Adeyemi",
...
export default function Testimonial() {
    return (
        <section className="w-full min-h-[60vh] flex flex-col items-center justify-center py-10 px-2 bg-linear-to-br from-white via-yellow-100 to-orange-100">
            <div className="w-full max-w-4xl mx-auto text-center mb-12">
                ...
                <p className="max-w-2xl mx-auto text-center text-yellow-900 text-lg md:text-xl mb-6 font-medium bg-white/90 rounded-xl px-6 py-4 shadow">
                    Every story here is a testament to the power of hope and community. <span className="font-semibold text-red-600">Adeniran Foundation</span> uplifts lives, one act of kindness at a time. These voices reflect the real impact of compassion, support, and opportunity—reminding us that together, we can create a brighter future for all.
                </p>
            </div>
