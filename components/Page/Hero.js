...
// Hero section for Adeniran Foundation
            ...
            <section className="relative w-full h-[90vh] md:h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Adeniran Foundation - Empowering Lives"
                        fill
                        priority
                        className="object-cover w-full h-full brightness-80"
                    />
                    {/* Gradient Overlay */}
                    <div className="absolute inset-0 bg-linear-to-br from-orange-400 via-yellow-400 to-red-500 opacity-70 mix-blend-multiply" />
                    {/* Subtle Pattern Overlay */}
                    <div className="absolute inset-0 pointer-events-none opacity-20 z-10" style={{backgroundImage: 'url("/images/pattern.svg")', backgroundRepeat: 'repeat', backgroundSize: '300px 300px'}} />
                </div>
