...
export default function News() {
    ...
    return (
        <section className="w-full py-12 px-4 bg-linear-to-br from-white via-yellow-100 to-orange-100 flex flex-col items-center justify-center">
                ...
                {newsData.map((news, idx) => (
                    ...
                    >
                        <div className="relative h-56 w-full">
                            ...
                            />
                            <div className="absolute top-0 left-0 w-full h-full bg-linear-to-t from-orange-600/60 via-yellow-400/30 to-transparent"></div>
                        </div>
                        <div className="flex flex-col flex-1 p-6">
                            ...
                            <div className="mt-auto flex justify-end">
                                <button className="px-4 py-2 rounded-lg bg-orange-600 text-white font-semibold hover:bg-red-600 transition-colors duration-200 shadow">
                                    Read More
                                </button>
                            </div>
                        </div>
            ...
            <div className="w-full flex justify-center mt-12">
                <a href="/blog" className="inline-flex items-center px-6 py-3 rounded-xl bg-orange-600 text-white font-bold text-lg shadow hover:bg-red-600 transition-colors duration-200 group">
                    View All Articles
            ...
            <div className="w-full mt-16 flex justify-center">
                <div className="relative w-full max-w-5xl rounded-3xl overflow-hidden shadow-xl">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-br from-orange-600/80 via-yellow-400/60 to-red-600/70 flex flex-col items-center justify-center px-6 py-8 md:px-16 md:py-12">
