    ...
    <footer className="w-full bg-gray-800 text-white py-10 px-4">
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-8">
        <div className="w-full flex flex-col items-center gap-2">
          <h2 className="text-3xl font-extrabold tracking-tight mb-1 text-orange-500">
            Othniel Foundation
          </h2>
        ...
        <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button variant="link" size="sm" href="/donate" className="rounded-full bg-orange-500 hover:bg-orange-600">
            Donate
          </Button>
          <Button variant="nav" size="sm" href="/contact" className="bg-yellow-400 text-orange-700 hover:bg-orange-500 hover:text-white">
            Volunteer
          </Button>
        </div>
        ...
        <p className="text-white/90 text-xs mb-2 text-center">
          Email: othnielsfoundation@gmail.com | Phone: +234 803 111 7861, +234 902 916 4846
        </p>
      </div>
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between mt-8 gap-4 border-t border-white/10 pt-6">
        ...
        <span className="text-xs text-white/70 mt-2 text-center">
          &copy; {new Date().getFullYear()} Othniels Foundation. All rights reserved.
        </span>
      </div>
    </footer>
  );
