...
export default function Contact() {
    return (
        <>
            <section className="relative w-full min-h-75 h-[40vh] sm:h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden font-sans">
                {/* Background Image */}
                ...
                {/* Content */}
                <div className="relative z-10 flex flex-col items-center text-center px-3 sm:px-4 max-w-2xl mx-auto">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white mt-6 mb-3 sm:mb-5 drop-shadow-lg tracking-tight">GET IN TOUCH</h1>
                    <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-yellow-200 mt-2 sm:mt-4 mb-2 sm:mb-4">Contact Us</h2>
                    <p className="text-base sm:text-lg md:text-xl text-white/90 mt-2 sm:mt-4 mb-3 sm:mb-4 font-medium drop-shadow-md">
            ...
            <section className="w-full py-8 font-sans">
                <div className="max-w-4xl mx-auto px-2 sm:px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                    {/* Phone Card */}
                    <div className="bg-white rounded-2xl shadow-lg flex flex-col items-center p-4 sm:p-6 border-t-4 border-yellow-400">
                    ...
                    {/* Email Card */}
                    <div className="bg-white rounded-2xl shadow-lg flex flex-col items-center p-4 sm:p-6 border-t-4 border-orange-400">
                    ...
                    {/* Address Card */}
                    <div className="bg-white rounded-2xl shadow-lg flex flex-col items-center p-4 sm:p-6 border-t-4 border-yellow-500">
                    ...
                    {/* Office Hours Card */}
                    <div className="bg-white rounded-2xl shadow-lg flex flex-col items-center p-4 sm:p-6 border-t-4 border-red-400">
